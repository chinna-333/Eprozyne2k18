...
<html>
<head>
	<title>EPROZYNE 2K18 | Treasure Hack | Onstie 3</title>
	<style type="text/css">
		body{
			display: flex;
			align-items: center;
...
<body>
	...
	<table class="table table-bordered table-striped" style="background-color: white">
		...
		<center id="question">Onsite Question 3</center>
		<div id="ques">
				Find the odd one among the following 
				<div>first  third  second</div>
				<div>forth  sixth  fifth</div>
				<div>seventh  ninth  eigth</div>
				<div>tenth</div>
		</div>
