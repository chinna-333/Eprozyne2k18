...
<html>
<head>
	<title>EPROZYNE 2K18 | Treasure Hack | Onstie 5</title>
	<style type="text/css">
		body{
			display: flex;
			align-items: center;
...
<body>
	...
	<table class="table table-bordered table-striped" style="background-color: white">
		...
		<center id="question">Onsite Question 5</center>
		<div id="ques">
			find the smallest number which gives a remainder 1 when divided with 2,3,4,5,6. but gives a remainder 0 when divided with 7. 
		</div>
