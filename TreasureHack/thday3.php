...
<html>
<head>
	<title>EPROZYNE 2K18 | Treasure Hack | Question 3</title>
	<style type="text/css">
		body{
			display: flex;
			align-items: center;
...
<body>
	...
	<table class="table table-bordered table-striped" style="background-color: white">
		...
		<center id="question">Question 3</center>
		<div id="ques">
				<div>Find the four digit number</div>
				<div>1st digit is half of 2nd digit</div>
				<div>sum of 2nd digit and third digit is 10</div>
				<div>4th digit = 2nd digit + 1</div>
				<div>sum of four digits = 23</div>
		</div>
