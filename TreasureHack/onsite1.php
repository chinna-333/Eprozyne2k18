...
<head>
	<title>EPROZYNE 2K18 | Treasure Hack | Onstie 1</title>
	<style type="text/css">
		body{
			display: flex;
			align-items: center;
...
<body>
	...
	<table class="table table-bordered table-striped" style="background-color: white">
		...
		<center id="question">Onsite Question 1</center>
		<div id="ques">
				The answer is hidden in the code. Hint: right-click and click on Inspect.
		</div>
